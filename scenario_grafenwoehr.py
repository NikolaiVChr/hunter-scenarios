...
def build_scenario(path: str) -> ScenarioContainer:
    static_targets = [
        ...
        StaticTarget(mpt.MPTarget.CONTARGET, g.Position(11.883669, 49.693864, 431.57), 270.0),
        StaticTarget(mpt.MPTarget.CONTARGET, g.Position(11.873286, 49.694864, 419.89), 270.0),
        StaticTarget(mpt.MPTarget.CONTARGET, g.Position(11.859642, 49.696071, 421.83), 270.0),
        StaticTarget(mpt.MPTarget.CONTARGET, g.Position(11.869534, 49.688501, 427.88), 255.0),
        StaticTarget(mpt.MPTarget.CONTARGET, g.Position(11.883086, 49.687430, 428.82), 255.0),
        StaticTarget(mpt.MPTarget.CONTARGET, g.Position(11.887024, 49.690743, 431.55), 260.0),
