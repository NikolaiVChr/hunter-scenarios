...
def build_scenario(path: str) -> ScenarioContainer:
    static_targets = [
        ...
        # SAMs + AAAs
        StaticTarget(mpt.MPTarget.S_300, g.Position(15.54266675, 45.03965636, 373.13), 35),
        StaticTarget(mpt.MPTarget.S_300, g.Position(15.42607613, 45.18618474, 250.01), 105),
        StaticTarget(mpt.MPTarget.BUK_M2, g.Position(15.48677027, 45.08705502, 374.41), 24),
        StaticTarget(mpt.MPTarget.BUK_M2, g.Position(15.44195858, 45.17045487, 256.01), 0),
        StaticTarget(mpt.MPTarget.BUK_M2, g.Position(15.46779326, 45.13225982, 300.99), 265),
