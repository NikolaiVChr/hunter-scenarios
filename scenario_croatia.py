...
def build_scenario(path: str) -> ScenarioContainer:
    static_targets = [
        ...
        StaticTarget(mpt.MPTarget.S_300, g.Position(15.42607613, 45.18618474, 250.01), 105, 1),
        StaticTarget(mpt.MPTarget.BUK_M2, g.Position(15.48677027, 45.08705502, 374.41), 24, 1),
        StaticTarget(mpt.MPTarget.BUK_M2, g.Position(15.44195858, 45.17045487, 256.01), 0, 1),
